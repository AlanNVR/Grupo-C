...
\subsection{Criterios éticos de uso de herramientas de generación de código con IA}
...
eligió por ser no trivial (posee tipo denido y no corresponde a un simple renombrado) y por su
...
modificar la configuración del generador. El atributo nuevo se reejó correctamente en la clase
